...
Quy trình "Chia để trị":

Xác định biến: Cần những biến nào để lưu dữ liệu? (gioLam, luongMoiGio, tongLuong).
...
5. Câu hỏi kiểm tra tư duy


Câu hỏi về biên: "Nếu nhập số giờ làm là âm (ví dụ -5 giờ), chương trình chạy ra sao? Làm thế nào để chặn lỗi này?" (Gợi ý: Dùng if để kiểm tra đầu vào).

Câu hỏi về kiểu dữ liệu: "Tại sao dùng double mà không dùng int cho lương?" (Gợi ý: Lương có thể có số lẻ).

Câu hỏi về mở rộng: "Nếu công ty đổi quy định làm thêm giờ từ 1.5 lên 2.0, em phải sửa dòng code nào?" (Gợi ý: Thay đổi hằng số, dẫn dắt đến việc sử dụng final double HESO_LAM_THEM = 1.5;).
